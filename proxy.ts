...
export async function proxy(request: NextRequest) {
  ...
  // Refreshes the session if needed; the result is intentionally ignored.
...
export const config = {
  // Match all pathnames except /api, /_next, /_vercel, /auth (callback), and static assets.
