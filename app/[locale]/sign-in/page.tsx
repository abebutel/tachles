  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-8">
      <div className="w-full max-w-md space-y-6">
        ...
        <p className="text-sm text-gray-600 text-center">{t("betaWarning")}</p>

        <button
          onClick={handleGoogle}
          className="w-full px-6 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition flex items-center justify-center gap-3"
        >
        ...
        {status === "sent" && (
          <p className="text-center text-green-600">{t("magicLinkSent")}</p>
        )}
        {status === "error" && (
